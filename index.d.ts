declare module 'express-mvc-ts' {
    ...
    export namespace MetadataSymbols {
        ...
        const ControllerRoutePrefixSymbol: unique symbol;
        const ControllerRouteParamsSymbol: unique symbol;
        const DependencyInjectionTypesSymbol: unique symbol;
        const DependencyServiceTypeSymbol: unique symbol;
    }
